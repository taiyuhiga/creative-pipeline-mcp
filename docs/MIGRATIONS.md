...
Changed:
- Fixed the package lockfile so clean CI installs resolve `is-buffer@1.1.6` correctly.

Migration:
- No caller action is required.
- Use `1.1.8-alpha.0` instead of `1.1.7-alpha.0`; the `1.1.7-alpha.0` release was superseded because CI/npm publish failed before the alpha package was published.
