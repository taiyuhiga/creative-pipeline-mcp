...
The dashboard is a local-only artifact and approval viewer. It can approve elevated tool requests and rerun the approved tool, so it must not be exposed to a network.
